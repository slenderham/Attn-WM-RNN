...
if __name__ == "__main__":
    ...
    def train(iters):
        ...
        for batch_idx in range(iters):
            ...
            loss = (output.reshape(args.stim_val**args.stim_dim*args.N_s, output_mask.shape[1], args.batch_size, 1)*output_mask-ch_s).pow(2).mean()/output_mask.mean() + args.l2r*hs.pow(2).mean() + args.l1r*hs.abs().mean()
